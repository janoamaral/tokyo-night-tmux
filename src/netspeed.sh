...
NET_ICONS[traffic_tx]="#[fg=${THEME[bblue]}]\U000f0cd8"    # nf-md-upload_network_outline
NET_ICONS[traffic_rx]="#[fg=${THEME[bgreen]}]\U000f0c66"   # nf-md-download_network_outline
