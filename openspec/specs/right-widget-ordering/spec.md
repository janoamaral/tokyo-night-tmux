...
Give the user control over the layout and order of the right-hand tmux status bar via the `@tokyo-night-tmux_show_right_widgets` option, including mixing named widgets with passthrough tmux format entries.
