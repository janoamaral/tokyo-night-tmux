...
# Highlight colors
tmux set -g mode-style "fg=${THEME[foreground]},bg=#2A2F41"
...
#+--- Windows ---+
# Focus
tmux set -g window-status-current-format "$RESET#[fg=#44dfaf,bg=#1F2335]  $window_number #[fg=${THEME[foreground]},bold,nodim]#W#[nobold,dim]#{?window_zoomed_flag, $zoom_number, $custom_pane} #{?window_last_flag,,} "
# Unfocused
