...
#+--- Bars LEFT ---+
# Session name
tmux set -g status-left "#[fg=${THEME[foreground]},bold] #[bold,nodim]#S$hostname "
tmux set -g status-left "#S$hostname  $battery_status$current_path$cmus_status$netspeed$git_status$wb_git_status$date_and_time"
